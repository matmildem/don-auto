...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('../dados/mock.json')
        ...
        .then((data) => {
            ...
            produtos.forEach((produto, index) => {
                ...
                btnAdicionar.className = "btn btn-dark btn-sm btn-adicionar-ao-carrinho";
                btnAdicionar.textContent = "Abrir detalhes";
                btnAdicionar.setAttribute('data-indice', index);
                ...
                cardBody.appendChild(btnAdicionar);
    ...
    $('#produtos-container').on('click', '.btn-adicionar-ao-carrinho', function () {
        ...
        $('#modalImagem').attr('src', produtoSelecionado.imagem);
        $('#modalDescricao').text(produtoSelecionado.descricao);
        $('#modalPreco').text('Cv: ' + produtoSelecionado.preco.toFixed(0));
